...
def sejong_motor_data_get():
    ...
    if sensor_parameter[1] == '1':
        if sensor_parameter[4] == '1':
            ...
            state_path[0] = getData['state_path']
            ...
            state_path[1] = getData['state_path']
            ...
            state_path[2] = getData['state_path']
        ...
        if sensor_parameter[4] == '1':
            ...
            state_path[3] = getData['state_path']
            ...
            state_path[4] = getData['state_path']
            ...
            state_path[5] = getData['state_path']
        ...
        if sensor_parameter[4] == '1':
            ...
            state_path[6] = getData['state_path']
            ...
            state_path[7] = getData['state_path']
            ...
            state_path[8] = getData['state_path']
